...
def purchase_course(tool_context: ToolContext) -> dict:
    ...
    # Get the current purchased course
    ...
    #Only include valid dictionary coursed
    ...
    #Update purhcased course in state via assigment
    ...
    #Create new interaction history with purchase date
    ...
    #update the interaction history in state via assignment
