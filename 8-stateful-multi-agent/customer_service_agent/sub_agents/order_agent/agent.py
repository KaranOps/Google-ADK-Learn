...
def refund_course(tool_context:ToolContext) -> dict:
    ...
    for course in current_purchased_courses:
        #Skip empty entries and non-dict entries
    ...
    #Update interaction history in state via assigment
...
order_agent = Agent(
    ...
    description="Order agent for viweing purchase history and process refunds",
    instruction=""""
